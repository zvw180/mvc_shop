<script src="http://localhost/mvc_shop/public/js/jquery-1.11.0.min.js"></script>
<script src="http://localhost/mvc_shop/public/js/jquery-migrate-1.2.1.min.js"></script>
